...
class Excel {
  ...
  static Future<RequestContext> run() async {
    ...
    js.PromiseJsImpl<excel_js.RequestContextJsImpl> promiseCallback(
        ...
        js.PromiseJsImpl<excel_js.RequestContextJsImpl>(
          allowInterop((final void Function(dynamic) resolve,
  ...
  static Future<void> copySheetsFromAsset(String assetPath,
    ...
    try {
      ...
      if (buildContext != null) {
        await showDialog(context: buildContext, builder: (BuildContext) {
...
class Workbook extends office_extension.ClientObject<excel_js.WorkbookJsImpl> {
  ...
  Future<void> insertWorksheetsFromBase64(String base64Data, Map<String, dynamic> options) async {
